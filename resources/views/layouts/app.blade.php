...
<head>
    ...
    <title>Provident Fund - Takoradi Technical University University</title>
            ...
            <nav class="uk-navbar">
                <div class="main_logo_top">
                    <a href="/dashboard"><img src='{{url("public/assets/img/logo.png")}}' alt="" height="15" width="71"/></a>
                     <span class="" style="color:white"  >Provident Fund</span>
...
<!--           <li class="uk-hidden-small"><a href='{!! url("/profile/show") !!}'><i title='home'class="material-icons">&#xE88A;</i><span>My Profile</span></a></li>
           -->
             ...
             <li data-uk-dropdown class="uk-hidden-small">
                    ...
                    <a href="#"><i class="sidebar-menu-icon material-icons md-18">school</i><span>Fund Module</span></a>
             ...
             @if( @Auth::user()->department=='Finance' || @Auth::user()->department=='top')
                   ...
                   <li data-uk-dropdown class="uk-hidden-small">
                    ...
                    <div class="uk-dropdown uk-dropdown-scrollable">
                        <ul class="uk-nav uk-nav-dropdown">
<!--                            <li><a href='#'>Update Staff Data</a></li>-->
                              <li><a href='{!! url("/upload/fund") !!}'>upload Fund Data</a></li>
                             
                           @if( @Auth::user()->username=='gadocansey@gmail.com' )
