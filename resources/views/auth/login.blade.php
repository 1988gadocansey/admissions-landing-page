...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Takoradi Polytechnic">
    <meta name="author" content="Takoradi Polytechnic">
    <title>Provident Fund | Takoradi Technical University</title>
    <meta name="msapplication-TileColor" content="#9f00a7">
...
<body class="blue-grey">
  ...
  <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text" style='color:white'>Provident Fund Management System</p>
          </div>
        </div>
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input id="username" type="text" required=""  placeholder="44545" name="fund">
