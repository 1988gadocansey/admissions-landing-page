...
class SystemController extends Controller
{
    ...
    public function getStaffgrade() {
         $grade = \DB::table('tpoly_workersgrade')->orderBy("grade")
                ->lists('grade', 'id');
        return $grade;
    }
     public function getRegions() {
         $region = \DB::table('tbl_regionns')
                ->lists('NAME', 'NAME');
        return $region;
    }
    ...
    public function getDesignation() {
         ...
         $designation = \DB::table('tpoly_designation')
                ->lists('designation', 'id');
         return $designation;
    ...
    public function  SearchStaff() {
        ...
        $data = \DB::table('tpoly_workers')->select("staffID")->get();
...
if(@\Auth::user()->role=='Lecturer' || @\Auth::user()->role=='HOD' ||@\Auth::user()->role=='Dean'){
    ...
    public function yearsDropDown(){
          $year = \DB::table('tpoly_provident_fund')->select('year')->groupBy('year')->get();
    ...
    public function monthDropDown(){
          $date = \DB::table('tpoly_provident_fund')->select('date')->groupBy('date')->get();
    ...
    public function getLectureList() {
     ...
     public function getLectureList_All() {
         ...
         $lecturer = \DB::table('tpoly_workers')->where('designation','Lecturer')->orderby("fullName")
